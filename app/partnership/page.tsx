...
import { Users, Briefcase, Check, ChevronDown } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 max-w-6xl mx-auto">
            ...
            <div className="w-full lg:w-5/12 bg-gray-900 p-10 md:p-14 text-white relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="relative z-10 mt-16 pt-8 border-t border-white/10">
                <p className="text-sm text-gray-400">Direct inquiries: <a href="mailto:team@nadoumiconsulting.com" className="text-orange-400 hover:text-orange-300">team@nadoumiconsulting.com</a></p>
              </div>
            </div>
              ...
              {submitted ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-12">
                  ...
                  <p className="text-lg text-gray-600 max-w-md mx-auto">
                    Thank you for your interest in partnering with Nadoumi. Our business development team will review your inquiry and get back to you within 24-48 hours.
                  </p>
                  <button 
                    onClick={() => setSubmitted(false)}
                    className="mt-8 text-orange-600 font-semibold hover:text-orange-700"
                  >
                    ...
                    {partnershipType === 'student' ? (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                          ...
                          <select required className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-shadow">
                        ...
                        <div>
                          ...
                          <input required className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-shadow" placeholder="e.g. MBBS" />
                        </div>
                        <div>
                          <label className="block text-sm font-semibold text-gray-700 mb-2">Preferred City</label>
                          <input required className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-shadow" placeholder="e.g. Beijing" />
                        </div>
                      </div>
                    ) : (
                      <div>
